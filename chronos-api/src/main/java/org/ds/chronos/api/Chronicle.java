 ...
 * Chronicle
 * <p>
 * A timeseries storage API with operations for storing columns, batches of columns, fetching ranges, deleting ranges, and counting ranges.
 * Events are composed of a long timestamp value and a byte[] of data.
 * <p>
...
public abstract class Chronicle {
	...
	private static final int STREAM_CHARACTERISTICS = Spliterator.DISTINCT | Spliterator.SORTED | Spliterator.ORDERED;
	...
	/**
	 * Get lazy loading stream of events. If t1 > t2, then the list will be iterated in reverse.
	 * 
	 * @param t1
	 *          begin time
	 * @param t1
	 ...
	 * @return
	 */
	public abstract Iterator<ChronologicalRecord> getRange(long t1, long t2, int pageSize);
	...
	/**
	 * Return a java stream of records for the time range
	 * 
	 * @param t1
	 * @param t2
	 * @return
	 */
	public Stream<ChronologicalRecord> getStreamRange(long t1, long t2) {
		return StreamSupport
		    .stream(Spliterators.spliteratorUnknownSize(getRange(t1, t2, READ_PAGE_SIZE), STREAM_CHARACTERISTICS), false);
	}
	 ...
	 * @return
	 */
	public Stream<ChronologicalRecord> getStreamRange(Date beginTime, Date endTime) {
		return getStreamRange(beginTime.getTime(), endTime.getTime());
	}
	 ...
	 * @return
	 */
	public Iterator<ChronologicalRecord> getRange(Date beginTime, Date endTime, int pageSize) {
