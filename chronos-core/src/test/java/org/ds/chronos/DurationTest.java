...
public class DurationTest extends TestBase {
	...
	public void testStrings() {
		...
		Assert.assertEquals("1y1w1d1h1m1s15ms", new Duration("1y 1w 1d 1h 1m 1s 15ms").toString());
	}
	...
	public void testPastJustify() {
		...
		Assert.assertEquals(expected, duration.justifyPast(duration.justifyPast(test)));
	}
	...
	public void testFutureJustify() {
		...
		Assert.assertEquals(expected, duration.justifyFuture(duration.justifyFuture(test)));
	}
