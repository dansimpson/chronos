...
/**
 * 
 * Utility class for representing a duration of time.  Supports short hand
 * codes for durations such as 1d, 1h, or 1h30m.
 * 
 */
public class Duration {
	...
	/**
	 * 
	 * @param number of milliseconds for duration
	 */
	 ...
	 * 
	 * units: y = year, w = week, d = day, h = hour, m = minute, s = second, 
	 * ms = milliseconds.
	 * 
	 * @param duration abbreviation
	 */
	...
	/**
	 * Justify date to the previous or current interval if the current
	 * time happens to fall on an interval line.
	 * 
	 * @param input
	 * @return
	 */
